...
import com.elhanko.hyperiongrabber.ng.tv.databinding.ActivityScanResultBinding;
...
public class ScanResultActivity extends LeanbackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descriptionText.setText(getResources().getString(
                com.elhanko.hyperiongrabber.ng.common.R.string.scan_result_description,
                partyPopper));
        ...
        if (extras != null){
            ...
            hostNameText.setText(
                    com.elhanko.hyperiongrabber.ng.common.R.string.error_no_host_name_extra);
        }
    ...
    private void saveResult() {
        ...
        prefs.putString(com.elhanko.hyperiongrabber.ng.common.R.string.pref_key_host, hostName);
        prefs.putInt(com.elhanko.hyperiongrabber.ng.common.R.string.pref_key_port, port);
    }
